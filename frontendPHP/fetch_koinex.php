...
$sql="SELECT ROUND(AVG(buyprice),2 ) as buyprice,ROUND(AVG(sellprice),2 ) as sellprice,datetime FROM koinex group by date(datetime) order by datetime desc limit ".$_POST['row'];
